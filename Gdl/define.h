...
#define	strcat		(gp_str_func.strcat)
#define	strrchr		(gp_strrchr)
...
void	clr_scr(void)
{
	...
	i = 19200; // 8bit, on affiche 4 pixels a la fois, 19200 = 320*240/4
...
void count_and_draw_fps(void)
{
	...
	sprintf(buffer,"%i|%i|%i",fps_count,frame_time,key_pressed) ;
